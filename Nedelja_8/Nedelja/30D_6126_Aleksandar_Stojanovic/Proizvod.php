<?php 
    ...
    // 30D_11.06.2021 Zadatak 1 
    class WebSite{

        function header(){
            echo "<h1><a href='index.php'>Dobro dosli na web-shop</a><h1>";
        }

        function footer(){
            echo "<h2>Bolje vas našli<h2>";
        }

        function meni(){
            echo "<ul>";
            echo "<li><a href='index.php?grupa=milka'>Milka</a></li>";
            echo "<li><a href='index.php?grupa=zelje'>Najlepse zelje</a></li>";
